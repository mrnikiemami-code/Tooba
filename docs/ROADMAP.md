...
```text
IN_PROGRESS (TB-P05-T001 through T014, TB-P05-T009-REPAIR-01, TB-P05-GOV-MIGRATION-BRIDGE-V2, and TB-P05-GOV-MIGRATION-BRIDGE-WAKE-V1 ACCEPTED; TB-P05-T015 REPAIR_IN_PROGRESS; TB-P05-T015-R1 AWAITING_ARCHITECT_ACCEPT; TB-P04-GATE ACCEPTED; P04 COMPLETE)
```
