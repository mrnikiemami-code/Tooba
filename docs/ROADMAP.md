...
```text
IN_PROGRESS (TB-P05-GATE ACCEPTED; P05 COMPLETE; TB-P06-T001 ACCEPTED; TB-P06-T002 AWAITING_ARCHITECT_ACCEPT; HOME_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK; PDP_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK)
```
