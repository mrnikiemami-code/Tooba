...
```text
IN_PROGRESS (TB-P05-GATE ACCEPTED; P05 COMPLETE; TB-P06-T001/T002/T003-R1 ACCEPTED; TB-P06-T003 SUPERSEDED_WRONG_TRANSPORT; TB-P06-T004 AWAITING_ARCHITECT_ACCEPT; MESSAGING_TRANSPORT = MASSTRANSIT_POSTGRESQL_SQL_TRANSPORT; HOME_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK; PDP_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK)
```
