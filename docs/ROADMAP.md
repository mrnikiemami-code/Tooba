...
| P06-22 | Production payment readiness (adapter boundary / fail-closed / reconcile / admin ops) | AWAITING_ARCHITECT_ACCEPT (TB-P06-T022; PRODUCTION_PAYMENT_FOUNDATION_READY; REAL_PSP_PROVIDER_CONFIGURATION_REQUIRED; not REAL_BANK_PAYMENT_PROVEN) |
