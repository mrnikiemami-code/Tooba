...
| P06-23 | Transactional notifications (customer/seller inbox from commerce events; Shopeiva UI) | AWAITING_ARCHITECT_ACCEPT (TB-P06-T023; TRANSACTIONAL_NOTIFICATIONS_LIVE; REALTIME_NOTIFICATIONS = DEFERRED; not REALTIME_NOTIFICATIONS_LIVE) |
