...
| P02-04 | Session / token / credential lifecycle | IN_PROGRESS |
...
- P02 Identity / Authorization is IN_PROGRESS under TB-P02-T004 (awaiting Architect accept).
- Locked messaging: MassTransit 8.5.10, PostgreSQL SQL Transport, RabbitMQ not used, one transport DB per deployment.
- `TB-P02-T005` is not authorized until Architect issues that envelope.
