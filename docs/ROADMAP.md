...
```text
IN_PROGRESS (TB-P05-T001 through T022 ACCEPTED; TB-P05-T023 = AWAITING_ARCHITECT_ACCEPT; TB-P04-GATE ACCEPTED; P04 COMPLETE)
```
...
| P05-23 | Seller Panel Shopeiva fidelity + live data | AWAITING_ARCHITECT_ACCEPT (TB-P05-T023) |
