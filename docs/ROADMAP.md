...
```text
IN_PROGRESS (TB-P05-T001 through T016, TB-P05-T016-R1, TB-P05-T015-R1, TB-P05-T009-REPAIR-01, TB-P05-GOV-MIGRATION-BRIDGE-V2, and TB-P05-GOV-MIGRATION-BRIDGE-WAKE-V1 ACCEPTED; TB-P05-T017 = REPAIR_IN_PROGRESS; TB-P05-T017-R1 = BLOCKED_ENVIRONMENT; TB-P05-T017-UNBLOCK-01 = AWAITING_ARCHITECT_ACCEPT; TB-P04-GATE ACCEPTED; P04 COMPLETE)
```
...
| P05-17 | Complete Shopeiva PDP tabs + live Q&A/wholesale | REPAIR_IN_PROGRESS (TB-P05-T017); R1 BLOCKED_ENVIRONMENT; UNBLOCK-01 AWAITING_ARCHITECT_ACCEPT |
