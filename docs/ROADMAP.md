...
```text
IN_PROGRESS (… TB-P06-T025 = ACCEPTED; TB-P06-T026-R1 = ACCEPTED; TB-P06-T027 = ACCEPTED; TB-P06-T028 = REPAIRED_BY_TB-P06-T028-R1; TB-P06-T028-R1 = ACCEPTED; TB-P06-T029 = AWAITING_ARCHITECT_ACCEPT; commercial coherence gate executed — route inventory + demo journeys + dead UX repair / customer dashboard honesty; COMMERCIAL_READINESS_GATE = AWAITING_ARCHITECT_ACCEPT; wallet LIVE/DEFERRED unchanged; WALLET_CHECKOUT_FULL_PAYMENT = LIVE; REFUND_TO_WALLET = LIVE; WALLET_CHECKOUT_BROWSER_PROOF = LIVE; REFUND_TO_WALLET_BROWSER_PROOF = LIVE; WALLET_CHECKOUT_USER_PREVIEW = READY; WALLET_MIXED_TENDER = DEFERRED; CUSTOMER_SETTINGS/SELLER_SETTINGS/ADMIN_PROFILE_SETTINGS = LIVE; REAL_PREFERENCES = PARTIAL; SETTINGS_USER_PREVIEW = READY; WALLET_LEDGER_LIVE; GIFTCARD_LIVE; SUPPORT_USER_PREVIEW = READY; ACCESS_CONTROL_USER_PREVIEW = READY; VISUAL_CONTRACT = SHOPEIVA_LOCKED; NOT USER_VISUAL_ACCEPTED; NOT PRODUCT_FULLY_READY; NOT PRODUCTION_GO_LIVE_READY; NOT P06 COMPLETE)
```
...
| P06-09 | Fulfillment & shipment foundation | ACCEPTED (TB-P06-T009 / TB-P06-T009-R1) |
| P06-10 | Fulfillment live UI integration (Customer/Seller/Admin) | REPAIR_REQUIRED (TB-P06-T010); fidelity repair TB-P06-T010-R1 AWAITING_ARCHITECT_ACCEPT |
| P06-16 | Locale-prefixed public routing (/fa,/en) + SEO | ACCEPTED (TB-P06-T016 through T016-R1) |
| P06-17 | Stories E2E (backend/admin + exact Shopeiva Story UI) | ACCEPTED (TB-P06-T017) |
| P06-18 | Commercial panel completion wave 1 (nav honesty + settings) | ACCEPTED (TB-P06-T018) |
| P06-19 | Shared Story Management (Admin/Seller one UI; review workflow) | ACCEPTED (TB-P06-T019-R1; T019 SUPERSEDED_BY_ARCHITECT_RESCOPE) |
| P06-20 | Commercial panel completion wave 2 (seller coupons/reviews; notifications deferred) | ACCEPTED (TB-P06-T020; COMMERCIAL_PANEL_WAVE2_LIVE) |
| P06-21 | Sellable product flow / commercial E2E closure | ACCEPTED (TB-P06-T021; SELLABLE_PRODUCT_FLOW_LIVE; ADVANCED_VARIANT_DEFERRED; not PRODUCTION_GO_LIVE_READY) |
| P06-22 | Production payment readiness (adapter boundary / fail-closed / reconcile / admin ops) | ACCEPTED (TB-P06-T022; PRODUCTION_PAYMENT_FOUNDATION_READY; REAL_PSP_PROVIDER_CONFIGURATION_REQUIRED; not REAL_BANK_PAYMENT_PROVEN) |
...
| P06-26-R1 | Wallet/Gift final proof — full validation + browser evidence + concrete preview | ACCEPTED (TB-P06-T026-R1) |
| P06-27 | Customer/Seller/Admin settings & profile completion (canonical owners; Shopeiva-locked UI; locale preference) | ACCEPTED (TB-P06-T027; SETTINGS_USER_PREVIEW_READY; not USER_VISUAL_ACCEPTED) |
| P06-28 | Wallet checkout spend + refund-to-wallet (atomic debit at Paid; mixed tender deferred) | REPAIRED_BY_TB-P06-T028-R1 (TB-P06-T028; WALLET_CHECKOUT_FULL_PAYMENT = LIVE; REFUND_TO_WALLET = LIVE; WALLET_MIXED_TENDER = DEFERRED) |
| P06-28-R1 | Wallet checkout/refund User-Preview URLs + browser proof (financial design unchanged; mixed tender deferred) | ACCEPTED (TB-P06-T028-R1; WALLET_CHECKOUT_BROWSER_PROOF = LIVE; REFUND_TO_WALLET_BROWSER_PROOF = LIVE; WALLET_CHECKOUT_USER_PREVIEW = READY; VISUAL_CONTRACT = SHOPEIVA_LOCKED) |
| P06-29 | Commercial coherence gate (route inventory + demo journeys + dead UX repair / customer dashboard honesty) | AWAITING_ARCHITECT_ACCEPT (TB-P06-T029; COMMERCIAL_READINESS_GATE = AWAITING_ARCHITECT_ACCEPT; VISUAL_CONTRACT = SHOPEIVA_LOCKED; evidence docs/evidence/TB-P06-T029/; not USER_VISUAL_ACCEPTED / PRODUCT_FULLY_READY / PRODUCTION_GO_LIVE_READY / P06 COMPLETE) |
