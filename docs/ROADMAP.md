...
```text
IN_PROGRESS (… TB-P06-T024-R2 = ACCEPTED; TB-P06-T025 = AWAITING_ARCHITECT_ACCEPT; SUPPORT_TICKETS_LIVE; SUPPORT_USER_PREVIEW = READY; ACCESS_CONTROL_USER_PREVIEW = READY; VISUAL_CONTRACT = SHOPEIVA_LOCKED; NOT USER_VISUAL_ACCEPTED; NOT PRODUCTION_GO_LIVE_READY)
```
...
| P06-25 | Customer & Seller Support Tickets (threaded Support module + Admin ops + Shopeiva UI) | AWAITING_ARCHITECT_ACCEPT (TB-P06-T025; SUPPORT_BACKEND = LIVE; SUPPORT_USER_PREVIEW = READY; not USER_VISUAL_ACCEPTED) |
