...
```text
IN_PROGRESS (TB-P05-T001 through T017, T017-R1, T017-UNBLOCK-01 ACCEPTED; TB-P05-T018 = AWAITING_ARCHITECT_ACCEPT; TB-P04-GATE ACCEPTED; P04 COMPLETE)
```
...
| P05-18 | Home page Shopeiva fidelity + live data | AWAITING_ARCHITECT_ACCEPT (TB-P05-T018) |
