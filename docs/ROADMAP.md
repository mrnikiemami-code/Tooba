...
| P01-08 | Cache abstraction & tenant-aware caching foundation | IN_PROGRESS |
...
- P01 Platform Foundation is IN_PROGRESS under TB-P01-T008 (awaiting Architect accept).
- Locked messaging: MassTransit 8.5.10, PostgreSQL SQL Transport, RabbitMQ not used, one transport DB per deployment.
- `TB-P01-T009` is not authorized.
