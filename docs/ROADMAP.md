...
```text
IN_PROGRESS (TB-P05-GATE ACCEPTED; P05 COMPLETE; TB-P06-T015 ACCEPTED; TB-P06-T016 ACCEPTED through T016-R1; TB-P06-T017 ACCEPTED; TB-P06-T018 ACCEPTED; TB-P06-T019 SUPERSEDED_BY_ARCHITECT_RESCOPE; TB-P06-T019-R1 ACCEPTED; TB-P06-T020 ACCEPTED; TB-P06-T021 ACCEPTED; TB-P06-T022 ACCEPTED; TB-P06-T023 REPAIRED_BY_TB-P06-T023-R1; TB-P06-T023-R1 AWAITING_ARCHITECT_ACCEPT; SHARED_STORY_MANAGEMENT_LIVE; COMMERCIAL_PANEL_WAVE1_LIVE; COMMERCIAL_PANEL_WAVE2_LIVE; SELLABLE_PRODUCT_FLOW_LIVE; PRODUCTION_PAYMENT_FOUNDATION_READY; REAL_PSP_PROVIDER_CONFIGURATION_REQUIRED; PRODUCT_SALE_FLOW = LIVE (demo); SELLER_OFFER_MANAGEMENT = LIVE; PRICING_PATH = LIVE; INVENTORY_PATH = LIVE; CART_CHECKOUT_PAYMENT = LIVE; SELLER_ORDER_FULFILLMENT = LIVE; CUSTOMER_ORDER_TRACKING = LIVE; ADVANCED_VARIANT_ARCHITECTURE = DEFERRED; SELLER_PROMOTIONS = LIVE; SELLER_REVIEWS = LIVE; ADMIN_PROMOTIONS = LIVE; ADMIN_REVIEWS = LIVE; TRANSACTIONAL_NOTIFICATIONS_LIVE = YES; REALTIME_NOTIFICATIONS = DEFERRED; PANEL_NAVIGATION = HONEST_LIVE_ONLY; STORY_LIVE = WITH_EXACT_SHOPEIVA_UI; PUBLIC_LOCALE_ROUTING = PREFIXED; MULTILINGUAL_SEO = LIVE; PAGE_COMPOSITION = LOCALE_ROUTE_COMPATIBLE; STOREFRONT/CUSTOMER/SELLER/ADMIN_UI = LIVE_AUDITED; BLOG_CONTENT = LIVE; VISUAL_CONTRACT = SHOPEIVA_LOCKED; COMMERCIAL_UI_READINESS = AUDITED; SETTLEMENT + RETURNS LIVE; AUTH_SESSION_STORAGE = HTTPONLY_COOKIE_SERVER_SIDE_PROPAGATION; PRODUCTION_OTP = PROVIDER_BACKED_FAIL_CLOSED; AUTHORIZATION = SPICEDB_REBAC; MESSAGING_TRANSPORT = MASSTRANSIT_POSTGRESQL_SQL_TRANSPORT; HOME_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK; PDP_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK; SELLABLE_DEMO = YES; NOT PRODUCTION_GO_LIVE_READY; NOT PRODUCT_FULLY_READY)
```
...
| P06-23 | Transactional notifications (customer/seller inbox from commerce events; Shopeiva UI) | REPAIRED_BY_TB-P06-T023-R1 (toastify parity + FE build + Shopeiva runtime proof; R1 AWAITING_ARCHITECT_ACCEPT; TRANSACTIONAL_NOTIFICATIONS_LIVE; VISUAL_PARITY PROVEN; REALTIME_NOTIFICATIONS = DEFERRED) |
