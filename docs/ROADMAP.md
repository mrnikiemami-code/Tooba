...
| P01-03 | Tenant, edition & database resolution foundation | IN_PROGRESS |
...
- P01 Platform Foundation is IN_PROGRESS under TB-P01-T003 (awaiting Architect accept).
- `TB-P01-T004` is not authorized.
