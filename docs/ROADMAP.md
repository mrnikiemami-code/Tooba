...
| P06-24 | Professional Access Control Center (Admin/Seller roles, ceiling, SpiceDB, scope + preview seed) | AWAITING_ARCHITECT_ACCEPT (TB-P06-T024-R2; T024-R1 FUNCTIONALLY_COMPLETE; ACCESS_CONTROL_DEMO_SEED = LIVE_DEV_ONLY; ACCESS_CONTROL_BROWSER_PROOF = LIVE; ACCESS_CONTROL_USER_PREVIEW = READY; not USER_VISUAL_ACCEPTED) |
