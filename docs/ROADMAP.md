...
| P06-24 | Professional Access Control Center (Admin/Seller roles, ceiling, SpiceDB, scope foundation) | AWAITING_ARCHITECT_ACCEPT (TB-P06-T024; ACCESS_CONTROL_CENTER_LIVE; RESOURCE_SCOPED_AUTHORIZATION_FOUNDATION_LIVE; order-query scope DEFERRED) |
