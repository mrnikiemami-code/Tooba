...
| P06-27 | Customer/Seller/Admin settings & profile completion (canonical owners; Shopeiva-locked UI; locale preference) | AWAITING_ARCHITECT_ACCEPT (TB-P06-T027; SETTINGS_USER_PREVIEW_READY; not USER_VISUAL_ACCEPTED) |
| P06-28 | Wallet checkout spend + refund-to-wallet (atomic debit at Paid; mixed tender deferred) | AWAITING_ARCHITECT_ACCEPT (TB-P06-T028; WALLET_CHECKOUT_FULL_PAYMENT_LIVE; REFUND_TO_WALLET_LIVE; WALLET_CHECKOUT_USER_PREVIEW_READY; WALLET_MIXED_TENDER = DEFERRED) |
