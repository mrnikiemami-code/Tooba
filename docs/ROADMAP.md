...
| P02-05 | Authentication HTTP / API boundary | IN_PROGRESS |
...
- P02 Identity / Authorization is IN_PROGRESS under TB-P02-T005 (awaiting Architect accept).
- Locked messaging: MassTransit 8.5.10, PostgreSQL SQL Transport, RabbitMQ not used, one transport DB per deployment.
- `TB-P02-T006` is not authorized until Architect issues that envelope.
