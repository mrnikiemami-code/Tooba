...
```text
IN_PROGRESS (TB-P05-T001 through T025 ACCEPTED; TB-P05-T026 = AWAITING_ARCHITECT_ACCEPT; P05 = AWAITING_ARCHITECT_GATE; TB-P04-GATE ACCEPTED; P04 COMPLETE)
```
...
| P05-26 | P05 live sellability completion gate | AWAITING_ARCHITECT_ACCEPT (TB-P05-T026) |
