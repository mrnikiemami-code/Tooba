...
Tax Calculation Foundation = IN_PROGRESS
```
...
6. execute `TB-P03-T007` repair validation evidence then await Architect review; do not start `TB-P03-T008` or P03 Gate unless Architect issues that envelope.
