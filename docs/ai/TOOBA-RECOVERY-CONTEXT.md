...
6. await Architect review of `TB-P00-T008`; do not execute `TB-P00-T009` unless Architect issues it.
7. P00 discovery inputs include `docs/architecture/00-technical-inventory.md` through `docs/architecture/07-catalog-product-offer.md` (not locked ADRs).
