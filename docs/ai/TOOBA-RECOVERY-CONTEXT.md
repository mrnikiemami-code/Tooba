...
6. TB-P05-GATE is Architect-accepted. P05 = COMPLETE. P06 = IN_PROGRESS. TB-P06-T022 = ACCEPTED; TB-P06-T023 = CLOSED_BY_REPAIR; TB-P06-T023-R1 = ACCEPTED; TB-P06-T024 = AWAITING_ARCHITECT_ACCEPT (`ACCESS_CONTROL_CENTER_LIVE`; `RESOURCE_SCOPED_AUTHORIZATION_FOUNDATION_LIVE`; `SELLER_PERMISSION_CEILING = LIVE`; category Mobile-vs-Books at authorization layer; order-query filtering DEFERRED; not `ALL_RESOURCE_SCOPES_FULLY_INTEGRATED`, not `USER_VISUAL_ACCEPTED`). Evidence under `docs/evidence/TB-P06-T024/`. HOME/PDP visual review remains OPEN_FOR_USER_FEEDBACK.
