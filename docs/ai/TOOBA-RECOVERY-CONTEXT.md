...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. Through TB-P05-T025 are ACCEPTED. TB-P05-T026 = AWAITING_ARCHITECT_ACCEPT for P05 live sellability completion gate; P05 = AWAITING_ARCHITECT_GATE (Worker must NOT mark P05 COMPLETE). Evidence under `docs/evidence/TB-P05-T026/`.
