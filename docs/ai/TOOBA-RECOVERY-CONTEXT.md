...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. TB-P05-T001 through T016 and TB-P05-T016-R1 are ACCEPTED. TB-P05-T017 = REPAIR_IN_PROGRESS; TB-P05-T017-R1 = AWAITING_ARCHITECT_ACCEPT for PDP sticky/fidelity PNG/zero-warning repair; evidence under `docs/evidence/TB-P05-T017/`.
