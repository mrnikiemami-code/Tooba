...
6. await Architect review of `TB-P00-T002`; do not execute `TB-P00-T003` unless Architect issues it.
7. P00 discovery inputs: `docs/architecture/00-technical-inventory.md`, `docs/architecture/01-capability-domain-map.md` (not locked architecture).
