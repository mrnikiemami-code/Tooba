...
6. await Architect review of `TB-P00-T011`; do not execute `TB-P00-T012` unless Architect issues it.
7. P00 discovery inputs include `docs/architecture/00-technical-inventory.md` through `docs/architecture/10-cart-checkout-order.md` (not locked ADRs).
