...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. TB-P05-T017 / T017-R1 / T017-UNBLOCK-01 are ACCEPTED. TB-P05-T018 = AWAITING_ARCHITECT_ACCEPT for Shopeiva Home fidelity with live data; evidence under `docs/evidence/TB-P05-T018/`.
