...
6. TB-P04-T006 is Architect-accepted. Current envelope is TB-P04-T007 (Shopeiva storefront live Home/Listing/PDP). Do not invent TB-P04-T008. Sell-first rule: preserve Shopeiva with minimum change and connect Tooba live APIs. Architecture: `docs/architecture/56-storefront-live-slice.md`.
