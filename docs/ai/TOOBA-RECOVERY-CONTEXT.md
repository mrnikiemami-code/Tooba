...
6. TB-P05-GATE is Architect-accepted. P05 = COMPLETE. P06 = IN_PROGRESS. TB-P06-T018 = ACCEPTED; TB-P06-T019 = SUPERSEDED_BY_ARCHITECT_RESCOPE; TB-P06-T019-R1 = ACCEPTED; TB-P06-T020 = ACCEPTED (`COMMERCIAL_PANEL_WAVE2_LIVE`); TB-P06-T021 = AWAITING_ARCHITECT_ACCEPT (`SELLABLE_PRODUCT_FLOW_LIVE`; `PRODUCT_SALE_FLOW = LIVE` demo; `ADVANCED_VARIANT_ARCHITECTURE = DEFERRED`; NOTIFICATIONS = DEFERRED_WITH_REASON; not `PRODUCTION_GO_LIVE_READY`; not PRODUCT_FULLY_READY). Evidence under `docs/evidence/TB-P06-T021/`. HOME/PDP visual review remains OPEN_FOR_USER_FEEDBACK.
