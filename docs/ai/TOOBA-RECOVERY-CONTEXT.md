...
P04 = COMPLETE
P05 = IN_PROGRESS
TB-P05-T001/T002/T003/T004/T005 = ACCEPTED
TB-P05-T006 = AWAITING_ARCHITECT_ACCEPT
Next Task = return TB-P05-T006 RESULT and wait in the same Architect chat
...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. TB-P05-T001/T002/T003/T004/T005 ACCEPTED. TB-P05-T006 is AWAITING_ARCHITECT_ACCEPT after backend-owned live storefront search/discovery bindings. Do not invent TB-P05-T007; send RESULT and wait in the same Architect chat. Deferred: Payment missing IdempotencyKey → 500/NRE; Cart replace-hold release→reserve window.
