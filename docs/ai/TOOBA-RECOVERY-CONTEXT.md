...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. TB-P05-T017 / T017-R1 / T017-UNBLOCK-01 / T018 / T018-UNBLOCK-01 are ACCEPTED. TB-P05-T019 = AWAITING_ARCHITECT_ACCEPT for Home/PDP visual regression guards; evidence under `docs/evidence/TB-P05-T019/` and `docs/visual-baselines/`.
