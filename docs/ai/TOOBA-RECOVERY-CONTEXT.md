...
6. await Architect review of `TB-P00-T018`; do not execute `TB-P00-T019` unless Architect issues it.
7. P00 discovery inputs include `docs/architecture/00-technical-inventory.md` through `docs/architecture/17-ai-assistant-rag.md` (not locked ADRs).
