...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. TB-P05-T017 / T017-R1 / T017-UNBLOCK-01 are ACCEPTED. TB-P05-T018 = BLOCKED_REMOTE_SYNC (Home fidelity on origin after transport recovery). TB-P05-T018-UNBLOCK-01 = AWAITING_ARCHITECT_ACCEPT; evidence under `docs/evidence/TB-P05-T018/` and `docs/evidence/TB-P05-T018-UNBLOCK-01/`.
