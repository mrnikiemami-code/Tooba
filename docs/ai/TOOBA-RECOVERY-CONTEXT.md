...
6. execute `TB-P03-T008` repair (durable Payment→Order projection) then await Architect ACCEPT; do not start `TB-P03-T009` or P03 Gate unless Architect issues that envelope.
