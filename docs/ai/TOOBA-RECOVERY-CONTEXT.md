...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. Through TB-P05-T024 are ACCEPTED. TB-P05-T025 = AWAITING_ARCHITECT_ACCEPT for live runtime visual acceptance + user preview; evidence under `docs/evidence/TB-P05-T025/`.
