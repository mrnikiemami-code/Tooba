...
6. await Architect review of `TB-P00-T005`; do not execute `TB-P00-T006` unless Architect issues it.
7. P00 discovery inputs include `docs/architecture/00-technical-inventory.md` through `docs/architecture/04-identity-authentication.md` (not locked ADRs).
