...
6. await Architect review of `TB-P00-T019`; do not execute `TB-P00-T020` unless Architect issues it.
7. P00 discovery inputs include `docs/architecture/00-technical-inventory.md` through `docs/architecture/18-observability-logging-audit.md` (not locked ADRs).
