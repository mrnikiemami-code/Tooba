...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. TB-P05-T001 through T016 and TB-P05-T016-R1 are ACCEPTED. TB-P05-T017 = REPAIR_IN_PROGRESS; TB-P05-T017-R1 = BLOCKED_ENVIRONMENT; TB-P05-T017-UNBLOCK-01 = AWAITING_ARCHITECT_ACCEPT for NuGet advisory + SpiceDB validation recovery; evidence under `docs/evidence/TB-P05-T017/` and `docs/evidence/TB-P05-T017-UNBLOCK-01/`.
