...
6. TB-P05-GATE is Architect-accepted. P05 = COMPLETE. P06 = IN_PROGRESS. TB-P06-T024-R2 = ACCEPTED; TB-P06-T025 = AWAITING_ARCHITECT_ACCEPT (`SUPPORT_BACKEND = LIVE`; `SUPPORT_USER_PREVIEW = READY`; not `USER_VISUAL_ACCEPTED`). Evidence under `docs/evidence/TB-P06-T025/`. HOME/PDP visual review remains OPEN_FOR_USER_FEEDBACK.
