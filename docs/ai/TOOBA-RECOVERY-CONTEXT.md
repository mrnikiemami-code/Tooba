...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. TB-P05-T001 through T012, TB-P05-T009-REPAIR-01, and TB-P05-GOV-MIGRATION-BRIDGE-V2 are ACCEPTED. TB-P05-T013 Bridge-V2 is AWAITING_ARCHITECT_ACCEPT. Wishlist now owns private actor/product references, idempotent add, safe remove, batched membership and count; Host composes current Storefront price, availability and Published ratings for the existing Shopeiva customer list, PDP and product-card hearts. Evidence is under `docs/evidence/TB-P05-T013/`. Deferred: Payment missing IdempotencyKey → 500/NRE; Cart replace-hold release→reserve window.
