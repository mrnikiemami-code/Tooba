...
6. TB-P04-GATE is Architect-accepted. P04 = COMPLETE. P05 = IN_PROGRESS. Through TB-P05-T020 are ACCEPTED. TB-P05-T021 = AWAITING_ARCHITECT_ACCEPT for Cart + Checkout Shopeiva fidelity with live commerce; evidence under `docs/evidence/TB-P05-T021/`.
