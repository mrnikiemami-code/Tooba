...
6. TB-P04-T004 is Architect-accepted. Current envelope is TB-P04-T005 (Admin Product Workspace). Visual ACCEPT is pending. Do not start Order/Seller/Customer workspaces or storefront overhaul. ErrorState retry i18n is RESOLVED; grid virtualization remains DEFERRED_NON_BLOCKING. Architecture: `docs/architecture/55-admin-product-workspace.md`.
