/**
 * Recovery SoT staleness guard (TB-P08-T008).
...
const CURRENT_TASK_ID = "TB-P08-T008";
...
test("recovery SoT current issued/repair points at idle after TB-P08-T008 not stale pointers", () => {
  const recovery = read(recoveryPath);
  const state = read(statePath);
