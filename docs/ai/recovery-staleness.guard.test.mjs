/**
 * Recovery SoT staleness guard (TB-P08-T001-R2).
...
const CURRENT_TASK_ID = "TB-P08-T001-R2";
...
test("recovery SoT current issued/repair points at idle after TB-P08-T001-R2 not stale pointers", () => {
  const recovery = read(recoveryPath);
  const state = read(statePath);
