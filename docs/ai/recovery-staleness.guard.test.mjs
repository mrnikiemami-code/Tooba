/**
 * Recovery SoT staleness guard (TB-P08-T005).
...
const CURRENT_TASK_ID = "TB-P08-T005";
...
test("recovery SoT current issued/repair points at idle after TB-P08-T005 not stale pointers", () => {
  const recovery = read(recoveryPath);
  const state = read(statePath);
