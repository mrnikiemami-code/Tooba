...
```text
NONE (Worker completing TB-P06-T004)
```
...
```text
IN_PROGRESS (TB-P06-T004 Worker PASS submitted = AWAITING_ARCHITECT_ACCEPT; TB-P06-T003-R1 ACCEPTED; MESSAGING_TRANSPORT = MASSTRANSIT_POSTGRESQL_SQL_TRANSPORT; HOME_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK; PDP_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK)
```
