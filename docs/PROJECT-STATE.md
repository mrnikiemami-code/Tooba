...
Resume: `PIPELINE-PROTOCOL: BRIDGE-WAKE-V1`; channel `tooba-main`. P05 = COMPLETE. P06 = IN_PROGRESS. TB-P06-T015 = ACCEPTED. TB-P06-T016 = REPAIR_REQUIRED. TB-P06-T016-R1 Worker PASS = AWAITING_ARCHITECT_ACCEPT: acceptance/evidence repair for locale-prefixed public routing (/fa,/en), 308 redirects, LocalizedLink preservation, canonical/hreflang/sitemap, RTL/LTR SSR+client sync, Page Composition locale-compatible, zero visual redesign. Evidence under `docs/evidence/TB-P06-T016-R1/`.
