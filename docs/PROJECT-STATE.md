...
```text
NONE (Worker completing TB-P06-T005)
```
...
```text
IN_PROGRESS (TB-P06-T005 Worker PASS submitted = AWAITING_ARCHITECT_ACCEPT; TB-P06-T001/T002/T003-R1/T004 ACCEPTED; AUTHORIZATION = SPICEDB_REBAC; MESSAGING_TRANSPORT = MASSTRANSIT_POSTGRESQL_SQL_TRANSPORT; HOME_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK; PDP_VISUAL_REVIEW = OPEN_FOR_USER_FEEDBACK)
```
