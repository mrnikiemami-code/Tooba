...
5. Never invent the next task from memory. Do not execute `TB-P00-T022` unless Architect issues that exact envelope.
...
Resume: await Architect review of TB-P00-T021. Do not execute `TB-P00-T022` unless Architect issues that envelope.
