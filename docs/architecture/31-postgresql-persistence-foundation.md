...
Outbox / domain+integration events: see `docs/architecture/33-outbox-domain-events-background-foundation.md` (TB-P01-T006).
MassTransit PostgreSQL SQL Transport: see `docs/architecture/34-masstransit-postgresql-sql-transport.md` (TB-P01-T007).
