...
- Accepted parent: TB-TMAR-PAYMENT-HOST-RESIDUE-REPAIR-001-R1 at <pending commit> (parent repair ACCEPTED_AFTER_R1_BEHAVIOR_PARITY_REPAIR: min poll cadence 15s restored, grid validation errors all stable semantic 400)
