...
- Post-closure quality: TB-TMAR-ORDER-POSTCLOSURE-QUALITY-001 (Order remains COMPLETE_REFERENCE_PATTERN)
- Current next task: USER_REVIEW_ORDER_POSTCLOSURE_QUALITY
