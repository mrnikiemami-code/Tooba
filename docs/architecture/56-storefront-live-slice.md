...
Status: IN_PROGRESS (TB-P04-T007 / awaiting Architect ACCEPT)

This slice mounts a Shopeiva-like storefront onto live Tooba Host composition. Frontend visual reuse is not domain-model reuse.
