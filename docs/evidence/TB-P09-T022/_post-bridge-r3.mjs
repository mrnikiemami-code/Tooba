...
const content = readFileSync(new URL("./RESULT-R3.bridge.txt", import.meta.url), "utf8");
const body = {
  channelId: "tooba-main",
  workerId: "tooba-worker-01",
  taskId: "TB-P09-T022-R3",
  status: "PASS",
  content,
};
writeFileSync("../../../../.tmp-t022r3-result-post.json", JSON.stringify(body));
...
const done = await fetch("http://127.0.0.1:17321/api/tasks/cf660ddd-cc34-4fe4-9ac1-e50a0c17ad38/complete", {
  method: "POST",
  headers: { "Content-Type": "application/json" },
  body: "{}",
});
