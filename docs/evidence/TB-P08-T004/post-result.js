...
const content = fs.readFileSync("docs/evidence/TB-P08-T004/RESULT.bridge.txt", "utf8");
const payload = { channelId: "tooba-main", taskId: "TB-P08-T004", content };
...
async function main() {
  ...
  const complete = await fetch(
    "http://127.0.0.1:17321/api/tasks/80ba6df3-cfcc-4fe7-bc57-628e2d32a9c7/complete",
