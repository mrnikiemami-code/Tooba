...
const content = fs.readFileSync("docs/evidence/TB-P08-T007/RESULT.bridge.txt", "utf8");
const payload = { channelId: "tooba-main", taskId: "TB-P08-T007", content };
...
async function main() {
  ...
  const complete = await fetch(
    "http://127.0.0.1:17321/api/tasks/52ddf4ce-9087-4d05-9698-e3ae4daf038a/complete",
