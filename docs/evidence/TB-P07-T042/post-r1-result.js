const fs = require("fs");
const content = fs.readFileSync("docs/evidence/TB-P07-T042/RESULT-R1.bridge.txt", "utf8");
const payload = {
  channelId: "tooba-main",
  taskId: "TB-P07-T042-R1",
  content,
};
fs.writeFileSync("docs/evidence/TB-P07-T042/result-r1-post.json", JSON.stringify(payload));
...
async function main() {
  ...
  const complete = await fetch(
    "http://127.0.0.1:17321/api/tasks/342cb658-050b-4215-8139-7eeca45d22f0/complete",
