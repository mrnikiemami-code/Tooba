...
const TASK_ID = "TB-TMAR-PAYMENT-PRECERT-DIRECTORY-SPLIT-001-R1";
const TASK_ROW_ID = "1cc2026a-8440-452f-ae57-c41f974d33e4";
const BRIDGE = "http://127.0.0.1:17321";

const content = fs.readFileSync(
  "docs/evidence/TB-TMAR-PAYMENT-PRECERT-DIRECTORY-SPLIT-001-R1/RESULT.bridge.txt",
  "utf8",
);
