const fs = require("fs");
const content = fs.readFileSync("docs/ai/tasks/TB-P07-T041.result.md", "utf8");
fs.writeFileSync("docs/evidence/TB-P07-T041/RESULT.bridge.txt", content);
const payload = {
...
fs.writeFileSync("docs/evidence/TB-P07-T041/result-post.json", JSON.stringify(payload));
...
async function main() {
  ...
  const complete = await fetch(
    "http://127.0.0.1:17321/api/tasks/09ea5adb-d1a0-4ef6-889f-cc820cf8cccf/complete",
