...
namespace Tooba.Support.Infrastructure.Seeds;
...
public static class SupportDevelopmentSeed
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var notifications = services.GetRequiredService<INotificationCreationPort>();
    ...
    private static async Task EnsureCustomerOpenAsync(
        SupportDbContext db,
        INotificationCreationPort notifications,
        Guid customerActorUserId,
        Guid adminActorUserId,
        DateTimeOffset now,
