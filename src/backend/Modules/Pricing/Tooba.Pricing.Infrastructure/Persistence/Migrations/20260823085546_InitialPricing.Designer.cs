...
namespace Tooba.Pricing.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260823085546_InitialPricing")]
            ...
            modelBuilder.Entity("Tooba.Pricing.Domain.AuthoredPrice", b =>
                {
                    ...
                    b.Property<string>("QualifierKey")
                        ...
                        .HasColumnName("qualifier_key");

                    b.Property<string>("QualifierKind")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("qualifier_kind");
                    ...
                    b.HasIndex("OfferId", "Market", "Channel", "Currency", "QualifierKind", "ValidFrom")
                        .HasDatabaseName("ix_prices_offer_id_market_channel_currency_qualifier_kind_vali");
