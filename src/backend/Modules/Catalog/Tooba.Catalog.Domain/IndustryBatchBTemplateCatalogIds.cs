...
/// <summary>شناسه‌های پایدار قالب Tile & Ceramic برای seed idempotent (Batch B).</summary>
public static class TileCeramicTemplateCatalogIds
{
    public const string Key = "tile-ceramic";
    private const string Ns = "019022b7";
...
/// <summary>شناسه‌های پایدار قالب Interior Decor برای seed idempotent (Batch B).</summary>
public static class InteriorDecorTemplateCatalogIds
{
    public const string Key = "interior-decor";
    private const string Ns = "019022b9";
...
/// <summary>شناسه‌های پایدار قالب Home Appliances برای seed idempotent (Batch B).</summary>
public static class HomeAppliancesTemplateCatalogIds
{
    public const string Key = "home-appliances";
    private const string Ns = "019022bb";
