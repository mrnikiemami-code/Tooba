...
/// <summary>شناسه‌های پایدار seed ساختاری Tile & Ceramic برای Batch B.</summary>
public static class TileCeramicTemplateParityIds
{
    private const string Ns = "019022b8";
...
/// <summary>شناسه‌های پایدار seed ساختاری Interior Decor برای Batch B.</summary>
public static class InteriorDecorTemplateParityIds
{
    private const string Ns = "019022ba";
...
/// <summary>شناسه‌های پایدار seed ساختاری Home Appliances برای Batch B.</summary>
public static class HomeAppliancesTemplateParityIds
{
    private const string Ns = "019022bc";
