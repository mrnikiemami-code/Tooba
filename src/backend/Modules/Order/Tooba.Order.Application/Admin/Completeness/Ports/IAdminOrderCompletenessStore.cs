...
namespace Tooba.Order.Application.Admin.Completeness.Ports;

public enum AdminOrderNoteDeleteOutcome
{
    Deleted,
    Forbidden,
    NotFound
...
public interface IAdminOrderCompletenessStore
{
    ...
    Task<AdminOrderNoteDeleteOutcome> DeleteNoteAsync(Guid checkoutId, Guid noteId, Guid actorUserId, CancellationToken cancellationToken);
