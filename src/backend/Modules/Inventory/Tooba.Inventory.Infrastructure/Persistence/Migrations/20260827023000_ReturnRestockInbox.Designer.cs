...
namespace Tooba.Inventory.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260827023000_ReturnRestockInbox")]
    partial class ReturnRestockInbox
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tooba.Inventory.Infrastructure.Persistence.ReturnRestockInboxRecord", b =>
                {
                    b.Property<string>("IdempotencyKey")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.HasKey("IdempotencyKey")
                        .HasName("PK_return_restock_inbox");

                    b.HasIndex("ReservationId")
                        .HasDatabaseName("IX_return_restock_inbox_reservation_id");

                    b.ToTable("return_restock_inbox", "inventory");
                });
