...
{
    [DbContext(typeof(OperatorProfileDbContext))]
    [Migration("20260827215300_InitialOperatorProfile")]
    partial class InitialOperatorProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("operator_profile")
            ...
            modelBuilder.Entity("Tooba.OperatorProfile.Domain.OperatorProfile", b =>
                {
                    ...
                    b.HasKey("OwnerUserId")
                        .HasName("pk_operator_profiles");

                    b.ToTable("operator_profiles", "operator_profile");
                });
            ...
            modelBuilder.Entity("Tooba.Persistence.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("outbox_messages", "operator_profile");
                });
