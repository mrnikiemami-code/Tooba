...
public sealed class ArchitectureBoundaryTests
{
    ...
    public void Host_composes_modules_from_explicit_list()
    {
        ...
        Assert.Contains(ToobaModuleComposition.Modules, module => module is CartModule);
        Assert.Contains(ToobaModuleComposition.Modules, module => module is OrderModule);
        Assert.Contains(ToobaModuleComposition.Modules, module => module is TaxModule);
        ...
        Assert.Contains(ToobaModuleComposition.Modules, module => module is ProductQnAModule);
        Assert.Contains(ToobaModuleComposition.Modules, module => module is BulkInquiryModule);
        ...
        Assert.Contains(ToobaModuleComposition.Modules, module => module is SupportModule);
        Assert.Contains(ToobaModuleComposition.Modules, module => module is WalletModule);
