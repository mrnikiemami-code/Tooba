...
public sealed class UnpaidOrderExpiryTests
{
    ...
    public void Retry_uses_same_order_and_ensure_supply()
    {
        ...
        var retry = Read("src/backend/Modules/Order/Tooba.Order.Application/Customer/Commands/RetryCustomerUnpaidOrder/RetryCustomerUnpaidOrderCommand.cs");
        Assert.Contains("RetryCustomerUnpaidOrder", retry, StringComparison.Ordinal);
