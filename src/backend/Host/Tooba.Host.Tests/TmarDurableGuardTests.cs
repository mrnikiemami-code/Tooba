...
public sealed class TmarDurableGuardTests
{
    ...
    public void Recovery_current_state_is_fresh_and_machine_readable()
    {
        ...
        Assert.Equal("USER_REVIEW_CART_MULTICURRENCY_LINES_001_R1", rootEl.GetProperty("nextTask").GetString());
        ...
        Assert.Equal("TB-TMAR-STORECONTEXT-GOLDEN-001", rootEl.GetProperty("lastAcceptedTask").GetString());
        Assert.Equal(
