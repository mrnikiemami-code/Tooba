...
/// <summary>Host transport adapter for Wallet admin Endpoints auth + capabilities.</summary>
public sealed class HostWalletAdminAuthorizer : IWalletAdminAuthorizer
{
    private readonly IAuthorizationService _authz;
    private readonly ICurrentTenant _tenant;

    public HostWalletAdminAuthorizer(IAuthorizationService authz, ICurrentTenant tenant)
    {
        _authz = authz;
        _tenant = tenant;
    }
