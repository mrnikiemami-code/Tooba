...
/// <summary>
/// نگاشت کد پایدار Offer به عنوان محلی در مرز Host/HTTP (نه Domain).
/// </summary>
internal static class OfferSemanticLocalizer
{
    /// <summary>عنوان محلی بر اساس فرهنگ درخواست یا fa پیش‌فرض.</summary>
    public static string Title(SemanticError error, string? cultureName = null)
    {
        ArgumentNullException.ThrowIfNull(error);
        var culture = cultureName ?? CultureInfo.CurrentUICulture.TwoLetterISOLanguageName;
        var en = culture.StartsWith("en", StringComparison.OrdinalIgnoreCase);
