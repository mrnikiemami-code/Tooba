...
/// <summary>Host transport adapter for Support customer Endpoints auth.</summary>
public sealed class HostSupportCustomerAuthorizer : ISupportCustomerAuthorizer
{
