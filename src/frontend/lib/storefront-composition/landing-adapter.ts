...
export const HOME_SECTION_TYPE_MAP: Record<string, { sectionTypeKey: string; variantKey: string }> = {
  ...
  product_rail_most_viewed: { sectionTypeKey: "ProductShowcase", variantKey: "product.zohreh" },
  ...
  newest_products: { sectionTypeKey: "ProductShowcase", variantKey: "product.mahoor" },
