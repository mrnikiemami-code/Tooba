  ...
  theme: {
    extend: {
      colors: {
        ...
        "section-surface": "rgb(var(--color-section-surface) / <alpha-value>)",
        "section-alternate": "rgb(var(--color-section-alternate) / <alpha-value>)",
        "section-accent": "rgb(var(--color-section-accent) / <alpha-value>)",
