...
export function StorefrontShopeivaFooter({ categories }: { categories: StorefrontCategoryItem[] }) {
  ...
  return (
    <footer className="relative mt-10 bg-surface border-t border-gray-200" data-storefront-footer-surface="true" data-storefront-surface-role="footer">
      <div className="border-b border-gray-200 bg-section-alternate">
