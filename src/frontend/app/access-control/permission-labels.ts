...
const FA: Record<string, PermissionLabel> = {
  ...
  "order.refund": { title: "بازگشت وجه سفارش", description: "ثبت بازگشت وجه مرتبط با سفارش" },
  ...
  "refund.view": { title: "مشاهده بازگشت وجه", description: "مشاهده بازگشت وجه" },
  "refund.manage": { title: "مدیریت بازگشت وجه", description: "ثبت و مدیریت بازگشت وجه" },
